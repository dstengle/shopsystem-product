...
**Bead:** [`lead-loos`](#) (P2) — System build manifest (BOM): explicit
component versions mapped to one overall system release version.
**Precursor input:** [`lead-h2p0`](#) (P2) — the inter-component
version-dependency view (which component bakes/requires which). The manifest
consumes that view's dependency data; this brief does not re-derive it.
**Anchored to:** the product authority's scope-refinement (David, 2026-06-30)
recorded on `lead-loos`, and the concrete version-line ambiguity that bit
[`lead-6b53`](#).
