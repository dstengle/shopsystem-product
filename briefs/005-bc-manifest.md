...
canonical names, and their GitHub remotes. The manifest is the single
source of truth from which derived artifacts (repos/ clones, DB
registry, bc-container launch lists, scenario assignment targets) are
populated."*
