...
four-repo split are in [`adr/001-framework-packaging.md`](adrs/adr-001.md).
...
- [`adr/001-framework-packaging.md`](adrs/adr-001.md) — split into four BC-aligned repos.
- [`adr/002-harness-bc-introduction.md`](adrs/adr-002.md) — fifth repo for the harness BC under Platform Operations.
...
[`adr/001-framework-packaging.md`](adrs/adr-001.md).
