...
*Adapted from [`deanpeters/Product-Manager-Skills/skills/prioritization-advisor`](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/prioritization-advisor) — fetched live 2026-07-10. Adaptation rules + experimental status: [`../README.md`](../README.md).*
