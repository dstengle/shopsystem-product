...
*Adapted from [`deanpeters/Product-Manager-Skills/skills/stakeholder-identification`](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/stakeholder-identification) — fetched live 2026-07-10. Adaptation rules + experimental status: [`../README.md`](../README.md).*
