...
*Adapted from [`deanpeters/Product-Manager-Skills/skills/problem-framing-canvas`](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/problem-framing-canvas) (MITRE Innovation Toolkit) — fetched live 2026-07-10. Adaptation rules + experimental status: [`../README.md`](../README.md).*
