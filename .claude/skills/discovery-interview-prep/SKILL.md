...
*Adapted from [`deanpeters/Product-Manager-Skills/skills/discovery-interview-prep`](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/discovery-interview-prep) — fetched live 2026-07-10. Adaptation rules + experimental status: [`../README.md`](../README.md).*
...
- Each assumption the interview targets is logged on the record as an **open
  validation question** with the segment that would answer it.
