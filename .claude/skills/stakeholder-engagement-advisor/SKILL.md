...
*Adapted from [`deanpeters/Product-Manager-Skills/skills/stakeholder-engagement-advisor`](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/stakeholder-engagement-advisor) (MITRE Innovation Toolkit) — fetched live 2026-07-10. Adaptation rules + experimental status: [`../README.md`](../README.md).*
