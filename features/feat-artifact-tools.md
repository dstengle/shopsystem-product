...
| 4 | 2026-09-09 | update | Delivered and verified by the lead-pm: artifact_tools.py reads and writes by part, renders children and references, fills hashes and a bead's initiative; the router reads one step through it. |
